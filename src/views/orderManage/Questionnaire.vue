      ...
      <div class="search" v-show="search">
        <a-form-model ref="queryRuleForm" :model="queryInfo" :rules="queryRules" :label-col="{ span: 6 }" :wrapper-col="{ span: 16 }" @keyup.enter.native="onSubmit">
          <a-row>
            ...
            <a-col :span="6">
              <a-form-model-item label="问诊状态" prop="status">
                <a-select v-model="queryInfo.status" placeholder="请选择问诊状态">
            ...
            <a-col :span="6">
              <a-form-model-item label="问诊方式" prop="type">
                <a-select v-model="queryInfo.type" placeholder="请选择问诊方式">
