          ...
          <div style="flex:8">
            <a-descriptions :column="2" size="small" bordered>
              ...
              <a-descriptions-item label="银行卡号">
                <a-input v-model="doctorInfo.card" :disabled="viewVisible" placeholder=""></a-input>
              </a-descriptions-item>
            </a-descriptions>
          </div>
        </a-row>
